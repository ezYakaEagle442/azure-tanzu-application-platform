...
param adminServerAppIdentityName string = 'id-tap-petclinic-admin-server-dev-westeurope-101'
...
param configServerAppIdentityName string = 'id-tap-petclinic-config-server-dev-westeurope-101'
...
param discoveryServerAppIdentityName string = 'id-tap-petclinic-discovery-server-dev-westeurope-101'
...
param apiGatewayAppIdentityName string = 'id-tap-petclinic-api-gateway-dev-westeurope-101'
...
param customersServiceAppIdentityName string = 'id-tap-petclinic-customers-service-dev-westeurope-101'
...
param vetsServiceAppIdentityName string = 'id-tap-petclinic-vets-service-dev-westeurope-101'
...
param visitsServiceAppIdentityName string = 'id-tap-petclinic-visits-service-dev-westeurope-101'
